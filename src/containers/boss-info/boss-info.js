    ...
    render() {
        ...
        return (
            <div>
                ...
                onChange={(value) => {this.handleChange('post',value)}}>招聘职位:</InputItem>

                <InputItem placeholder='请输入公司名称'
                onChange={(value) => {this.handleChange('company',value)}}>公司名称:</InputItem>
                
                <InputItem placeholder='请输入职位薪资'
                onChange={(value) => {this.handleChange('salary',value)}}>职位薪资:</InputItem>
